...
// Getters and Setters
/**
 * The getters for the LinkNode class get & read the data of the node, and pointer to the next node, 
...
/**
 * The setters for the LinkNode class update the data and position of the node and set them so that they can be manipulated 
 * in add/remove methods in the linked list, and elsewhere in the program.
 * 
 * Pre: none
