 ...
 * attributes noteValue and coinValue. This class has constructors,
 * getters/setters and methods add, subtract, isEqual and isGreater, which 
 * compare and manipulate different currency objects.
 */
public abstract class Currency {
  ...
  // Getters and Setters
  /**
   * The getters for the Currency class get & read the coin (fraction) and note
   * (whole) values so that they can be manipulated in add/subtract/isEqual/isGreater
   * methods, and elsewhere in the program.
   * Pre: None.
   * Post: the value of the note and/or coin variable is returned.
   */

  /**
   * The setters for the Currency class update the coin (fraction) and note
   * (whole).
   * values and set them so that they can be manipulated in
   * add/subtract/isEqual/isGreater methods,
   ...
   * the noteValue is incremented, and the coinValue gets updated to be the
   * remainder.
   * of coinValue divided by 100.
   * Post: The input object is added and the value of noteValue and coinValue is
   * updated.
   */
   ...
   * "Invalid subtraction" message is printed out to the console.
   * Post: The input object is subtracted and the value of noteValue and coinValue
   * is updated.
   */
   ...
   * Pre: Check to see if the value of noteValue and coinValue is less than or
   * greater.
   * than the note and coin value of currency obj.
   * Post: If the values of the input object and noteValue and coinValue are
   * greater than.
   * the note and coin value of currency obj, true is returned, otherwise false is
   * returned.
   */
  ...
  /**
   * The method print was changed to toString() which prints out the value of the
   * coin + dollar.
   * Change for Lab 3: Changed return type to String to use in SinglyLinkedList.
   * Pre: None.
   * Post: The name and value of the currency object is printed, along with the
   * appropriate currency name.
   */
