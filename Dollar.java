 ...
 * CS 22C
 * Dollar.java is designed to act as a derived class from Currency.
 * Date: 5/9/22
 * This class creates a Dollar object that can be manipulated.
 */
public class Dollar extends Currency {
   ...
   * so that they can be manipulated in add/subtract/isEqual/isGreater methods,
  ...
  /**
   * The subtract method subtracts an input object (called obj) of the currency
   * Dollar.
   * Pre: Check to see if the currency name of the input object is the same.
   ...
   * Pre: None.
   * Post: Returns true if the input object of type Dollar currency is greater
   * than.
  ...
  /**
   * The isEqual method compares an input object of the currency Dollar for
  ...
  /**
   * The print method prints the name and value of the dollar currency object in
   * the form xx.yy, followed by dollar.
   * Change for Lab 3: Changed return type to String to use in SinglyLinkedList
   * Pre: None.
   * Post: The name and value of the currency object is printed, along with dollar
