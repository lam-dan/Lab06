 ...
 * CS 22C
 * Date: 5/9/22
 * Stack.java is designed to act as the stack class where operations
 * like push and pop are defined. The data from the stack
...
public class Stack extends SinglyLinkedList {
  ...
  /**
   * The push method takes a Currency object as parameter and adds it to the top
   * of the stack.
   * Pre: None.
  ...
  /**
   * The pop method removes and returns the Currency object from the top of the
   * stack.
  ...
  /**
   * The printStack method returns a string with contents of the stack from the
   * top to bottom.
   * Pre: None.
